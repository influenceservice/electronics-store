...
if __name__ == '__main__':
    with app.app_context():
        ...
        # Добавляем товары
        products = [
            Product(name="NVIDIA GeForce RTX 4090", price=2599.99,
                    description="Флагманская видеокарта с 24 ГБ памяти",
                    image_url="https://static.nix.ru/autocatalog/video_cards_gigabyte/image/131921_m.jpg",
            ...
            Product(name="AMD Radeon RX 7900 XTX", price=1099.99,
                    ...
                    image_url="https://static.nix.ru/autocatalog/video_cards_asus/image/134624_m.jpg",
                    category_id=cat_gpu.id),
